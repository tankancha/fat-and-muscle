...
(function () {
  ...
  const RAW = {
    ...
    8: {  // missed: Wason
      Ohm:[35.75,60.85], Maneenund:[37.5,58.75], Pipat:[18.8,76.9], Pruang:[18.8,76.8],
      Nott:[22.6,73.3], Orawan:[36,60.2], Jue:[29.05,67.15], Ann:[23.7,72.2],
      Piyathida:[23.8,71.9], Best:[24.3,71.7], Sonny:[21.5,74.1], Bob:[32,64.3],
      Ben:[24.5,71.5],
    },
  };
